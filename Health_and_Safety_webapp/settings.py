"""
Django settings for Health_and_Safety_webapp project.
...
ROOT_URLCONF = 'Health_and_Safety_webapp.urls'
...
WSGI_APPLICATION = 'Health_and_Safety_webapp.wsgi.application'
